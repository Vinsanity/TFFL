...
if ( ! function_exists( 'rudiments_custom_image_sizes' ) ) {
	/**
	 * Custom thumbnail sizes selectable in the WordPress admin
	 *
...
if ( ! function_exists( 'rudiments_num_page_navi' ) ) {
	/**
	 * Numeric Page Navi
	 *
